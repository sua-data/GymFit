const trainerSignupForm = document.querySelector(
  "#trainerSignupForm"
);
...
const trainerNameInput = document.querySelector(
  "#trainerName"
);

const trainerEmailInput = document.querySelector(
  "#trainerEmail"
);

const trainerPasswordInput = document.querySelector(
  "#trainerPassword"
);

const trainerPasswordConfirmInput =
  document.querySelector(
    "#trainerPasswordConfirm"
  );
...
const agreeTrainerPolicy = document.querySelector(
  "#agreeTrainerPolicy"
);
...
function clearFormError() {
  ...
  window.gymfitAuthValidation?.clearAll(trainerSignupForm);
}
...
function setEmailMessage(
  ...
  trainerEmailInput.toggleAttribute("aria-invalid", Boolean(message) && !isSuccess);
...
function resetVerification() {
  ...
  trainerEmailInput.readOnly = false;
...
verificationButton.addEventListener(
  ...
  async () => {
    ...
    try {
      ...
      trainerEmailInput.readOnly = true;

      verificationCodeInput.readOnly =
        true;
...
trainerEmailInput.addEventListener(
  "input",
  () => {
    resetVerification();
    clearFormError();
...
trainerSignupForm.addEventListener(
  "submit",
  (event) => {
    ...
    const passwordConfirm =
      trainerPasswordConfirmInput.value;
